...
$.lang.data["net.phantombot.pointsystem.name-success-both"] = "$1 была изменена с \"$2\" на \"$3\". Назначьте имя для $4 используя \"!points name single <имя>\".";
$.lang.data["net.phantombot.pointsystem.name-success-multiple"] = "Имя мульти??? $1 изменено с \"3 $2\" на \"3 $3\". Для выставления имени для $4 используйте \"!points name single <имя>\".";
