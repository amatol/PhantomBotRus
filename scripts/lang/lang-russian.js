...
$.lang.data["net.phantombot.init.module-usage"] = "Использование: !module list, !module enable <module name>, !module disable <module name>, !module status <module name>";
...
//misc.js
$.lang.data["net.phantombot.misc.log-status"] = "Logging is currently $1! Логи хранятся в течение $2 дней! Для изменения этих параметров используйте '!log <enable or disable>' or '!log days <number of days>'";
$.lang.data["net.phantombot.misc.log-enable"] = "Запись лога включена!";
$.lang.data["net.phantombot.misc.log-disable"] = "Запись лога выключена!";
$.lang.data["net.phantombot.misc.logchat-enable"] = "Запись лога чата включена!";
$.lang.data["net.phantombot.misc.logchat-disable"] = "Запись лога чата выключена!";
$.lang.data["net.phantombot.misc.log-err-bad-days"] = "Пожалуйста, введите действительное число дней больше 0. Использование: '!log days <number of days>'";
$.lang.data["net.phantombot.misc.log-days"] = "Теперь логи хранятся в течение $1 дней!";
$.lang.data["net.phantombot.misc.response-enabled"] = "Ответы бота включены для всех. Для их выключения, say : !response disable";
$.lang.data["net.phantombot.misc.response-disabled"] = "Ответы бота выключены для всех. Для их включения, say: !response enable";
$.lang.data["net.phantombot.misc.response-enable"] = "Теперь ответы включены! Чтобы выключить их, say: !response disable";
$.lang.data["net.phantombot.misc.response-disable"] = "Теперь ответы выключены! Чтобы их включить, say: !response enable";

//permissions.js
$.lang.data["net.phantombot.permissions.group-not-exists"] = "Эта группа не существует! Для просмотра списка групп используйте !group list.";
$.lang.data["net.phantombot.permissions.group-remove"] = "Группа $1 была удалена. Все участники этой группы были перемещены в группу Наблюдателей.";
