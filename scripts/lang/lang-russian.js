...
//raffleSystem.js
$.lang.data["net.phantombot.rafflesystem.start-success-followers-price"] = "/me [Raffle Started] Войдите для получения шанса на выигрыш [$1]! Вы должны быть подписчиком для того, чтобы войти, плата за вход $2. Для участия в розыгрыше введите \"$3\".";
...
$.lang.data["net.phantombot.rafflesystem.start-success-price"] = "/me [Raffle Started] Войдите для получения шанса на выигрыш [$1]! Плата за вход $2. Для участия в розыгрыше введите \"$3\".";
$.lang.data["net.phantombot.rafflesystem.start-success-default"] = "/me [Raffle Started] Войдите для получения шанса на выигрыш [$1]! Для участия в розыгрыше введите \"$2\".";
$.lang.data["net.phantombot.rafflesystem.start-usage-points"] = "Недопустимый формат. Использование: \"!raffle start [-followers] <награда> [<цена>] [<ключевое слово>]\".";
$.lang.data["net.phantombot.rafflesystem.start-usage-default"] = "Недопустимый формат. Использование: \"!raffle start [-followers] <награда> [<ключевое слово>]\".";
$.lang.data["net.phantombot.rafflesystem.start-error-invalid-points"] = "Ключевое слово может быть как \"!raffle\" или слово без \"!\". Использование: \"!raffle start [-followers] <награда> [<цена>] [<ключевое слово>]\"."
$.lang.data["net.phantombot.rafflesystem.start-error-invalid-default"] = "Ключевое слово может быть как \"!raffle\" или слово без \"!\". Использование: \"!raffle start [-followers] <награда> [<ключевое слово>]\"."
